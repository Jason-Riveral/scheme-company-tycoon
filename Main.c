    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 5:
                ...
                printf("Total Money Earned:"OFF""GREEN" $%d"OFF"\t\t"YELLOW"Total Employees Hired:"OFF" "RED"%d\n"OFF, CEO_Comm, Employee_Count);
            ...
            case 7:
                ...
                while(1){
                    ...
                    typeText(YELLOW ITALIC_ON"Changed your mind? Kind of an indecisive man aren't you.\n\n\n"OFF YELLOW"[1]"HGRN" Yeah, so what?!\n"OFF YELLOW"[2]"OFF RED" Well, maybe you're right!"OFF YELLOW"Decision: "OFF,textSpeed);
                    int choice; scanf("%d", &choice); getchar();
                    if (choice == 1) {
